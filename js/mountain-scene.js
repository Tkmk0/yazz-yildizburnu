...
function initMountainScene() {
  var mount = document.getElementById('mountain-mount');
  if (!mount) return;
  ...
  // Geometry
  var geometry = new THREE.PlaneGeometry(12, 8, 128, 128);
  ...
  // Point light (uniform için referans)
  ...
  function onMouseMove(e) {
    ...
    var pos = new THREE.Vector3(x * 5, 2, 2 - y * 2);
